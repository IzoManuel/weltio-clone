...
onMounted(() => {
  leftCardObserver.value = onIntersect(leftCardRef.value, onEnterLeftCard, onExit, false, {
    threshold: 0.8,
  });
  rightCardObserver.value = onIntersect(leftCardRef.value, onEnterRightCard, onExit, false, {
    threshold: 0.8,
  });
});
