            ...
            <div id="col-left" class="lg:w-[50%]">
              ...
              >
                ...
                >
                  ...
                  ><tvbox class="inline"></tvbox> <span class=""> to grow </span
              ...
              >
                <p class="">
                  ...
                  markets with a multi-currency account
                </p>
              </div>
              <div
                id="hero-action"
                ...
                >
                  ...
                  >
                    <span
                      ...
                      >Depositar</span
                    >
                    <span class="text-[8px] rounded-full px-2 py-1 bg-[#e8f2cf]"
                      >Invetir</span
                    >
                  </div>
                </div>
                  ...
                  >
                    <div
                      ...
                      v-for="(cardItem, index) in [
                        ...
                        { subTitle: 'Stock', stat1: '+3.51', stat2: '+1.35%' },
                        {
                          subTitle: 'Savubgs',
                          stat1: '+0.24',
                          stat2: '+0.17%',
              ...
              <div id="col-right" class="flex flex-col">
                ...
                >
                  <p>
                    ...
                    worldwide who trade fractional shares, ETFs and cryptos. Our
                    easy-to-use platform helps you every step of the way
                  </p>
                </div>
                <div
                  id="overveiw-actions"
        ...
        >
          ...
          >
            ...
            <div id="sreenshot-description" class="">
              ...
              >
                With so many cryptocurrencies to choose from, Weltio helps you
                make sense of it all to build your own crypto portfolio
              </p>
            </div>
          </div>
          <div
    ...
    <section id="offer">
      <div id="offer-content" class="py-[60px]">
        ...
        >
          ...
          <div id="offer-actions" class="flex justify-center gap-5 mt-[44px]">
            <action-button :action-label="'App Store'"></action-button>
            <action-button :action-label="'Google Play'"></action-button>
          </div>
        </div>
      ...
      >
        ...
        >
          <div id="footer-grid" class="grid grid-cols-1 md:grid-cols-2">
            ...
            <div id="col-right" class="pt-[40px] md:p-0 lg:justify-self-end">
          ...
          >
            ...
            <p
              class="leading-[145%] tracking-[0.02em] text-[12px] mb-[10px] md:text-[14px] md:mb-[20px] lg:text-[16px]"
            >
              Weltio is a trading name of Weltio LLC. The information provided
              by Weltio does not constitute advice or a recommendation to buy,
              sell, or hold securities. All investments involve risk; the past
              performance of a security or financial product does not guarantee
              future results or returns. With any investment in securities or
              financial products, there is always a risk of losing money.
            ...
            >
              ...
              noted, Weltio and its affiliates are not partners, affiliates, or
              licensees of these companies.
            </p>
            <p
              class="leading-[145%] tracking-[0.02em] text-[12px] mb-[10px] md:text-[14px] md:mb-[20px] lg:text-[16px]"
            >
              Content, news, research, tools, market data and securities symbols
              are for educational and illustration purposes only and are not
              substitutes for professional advice. All information provided is
              ...
              any information on this website, our Weltio mobile application or
              our associated social media pages.
            </p>
            <p
              class="leading-[145%] tracking-[0.02em] text-[12px] mb-[10px] md:text-[14px] md:mb-[20px] lg:text-[16px]"
            >
